...
# ---------------------------------------------------------------------------
# Passive type registry
# ---------------------------------------------------------------------------

PASSIVE_TYPES: dict[str, dict[str, str]] = {
    "Resistors": {
        "prefix": "R",
        "value_param": "Resistance",
        "library_pattern": "GS_Resistor_{package}",
    },
    "Capacitors": {
        "prefix": "C",
        "value_param": "Capacitance",
        "library_pattern": "GS_Capacitor_{package}",
    },
}
...
def determine_library_name(parent_category: str, package: str) -> str:
    ...
    return type_info["library_pattern"].format(package=package)
...
def build_passive_plan(
    ...
    if not library_path.exists():
        raise ImportErrorWithExitCode(
            ...
            "'make import' to establish a base symbol first",
            exit_code=1,
        )
